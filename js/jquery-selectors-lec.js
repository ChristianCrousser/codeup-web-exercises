...
$(document).ready(function() {
    ...
    // TODO BONUS: Add additional elements to the page, and practice changing the css or viewing the contents
        ...
        $("h4").css("background-color", "purple");
    ...
    $("#romance-genre, #international-genre, #book-bundle-one").css("background-color", "pink");
    $("#science-fiction-genre, #book-bundle-two").css("background-color", "green");
