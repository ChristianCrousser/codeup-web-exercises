$(document).ready(function(){
    ...
    // console.log($.ajax("https://hookb.in/pzk2dDlO8qh1GKb9nL7B?username=Bob"));
    ...
    // console.log($.ajax("https://hookb.in/pzk2dDlO8qh1GKb9nL7B", person));
    ...
    // console.log($.ajax("https://hookb.in/pzk2dDlO8qh1GKb9nL7B", people));
...
/*
    ...
    newMovie.done(function(data) {
        console.log("The Force Awakens came out in " + data.results[0].release_date);
    });
    ...
    var oneBook = $.get("data/books.json");

    oneBook.done(function(data) {
